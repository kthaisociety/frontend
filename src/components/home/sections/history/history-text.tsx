  ...
  return (
    ...
    >
      ...
      <p className={`mt-5 text-gray-1000 ${paragraphSize}`}>
        Since our founding in 2018, AI Society has been organizing events with
        industry leaders. We host workshops, lectures, hackathons and more for
        anyone wanting to join our AI community at KTH.
      </p>

      <p className={`mt-5 text-gray-1000 ${paragraphSize}`}>
        Are you a student interested in joining our upcoming events? Or perhaps
        an industry professional looking to collaborate?
      </p>
