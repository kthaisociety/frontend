...
> = {
  ...
  Research: [
    "The AI Research Team explores frontier and applied AI through project-based work, paper reading, experimentation, evaluation, and technical communication. As a member, you will work in small teams to understand recent AI advances, reproduce or extend methods, design experiments, build research prototypes, evaluate systems, and communicate findings clearly.",
    "Our work is especially suited for students who enjoy bridging research and implementation: testing ideas in code, comparing methods, building useful artifacts, and contributing to the broader AI community. Projects may range from theoretical or experimental investigations to applied systems work, such as improving model efficiency, evaluation methods, tooling, or open-source ML infrastructure. Outputs may include technical reports, demos, workshops, blog posts, benchmarks, open-source contributions, or, where appropriate, research papers.",
    "We are looking for students who have fun to read and discuss research papers and are excited to tinker deeply about AI systems. You do not need prior publication experience, but you should be comfortable engaging with technical heavy material, learning new frameworks and have a strong willingness to learn. The team would be a good fit if you are interested in areas such as LLMs, evaluation, reinforcement learning, computer vision, multimodal AI, robotics, embodied AI, machine learning, or AI infrastructure, and want to develop both technical depth and research judgement.",
    "Relevant skills include programming (Python, C/C++, Rust), machine learning knowledge, mathematical maturity and clear communication. Experience with PyTorch, TensorFlow, or similar ML frameworks is especially valuable, as is experience training, evaluating, or fine-tuning models. Skills in experiment tracking, Git/GitHub collaboration, data handling with NumPy, Pandas/Polars, or scikit-learn, and previous work with LLMs, computer vision, robotics, mathematical modeling, systems, or research projects are a plus, but not required.",
  ],
  Growth: [
